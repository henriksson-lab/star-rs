...
pub struct ReadAlign {
    ...
    pub wc: Vec<[u32; crate::include_define::WC_SIZE]>,
    pub wa: Vec<Vec<[u32; crate::include_define::WA_SIZE]>>,
    pub n_wa: Vec<u32>,
    pub n_wap: Vec<u32>,
    pub wal_rec: Vec<u32>,
    ...
    pub pc: Vec<[u32; crate::include_define::PC_SIZE]>,
}
